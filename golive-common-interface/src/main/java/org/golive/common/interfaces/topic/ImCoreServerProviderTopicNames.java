package org.golive.common.interfaces.topic;
...
public class ImCoreServerProviderTopicNames {
     ...
     * 接收im系统发送的业务消息
     */
    public static final String GOLIVE_IM_BIZ_MSG_TOPIC = "golive_im_biz_msg_topic";

    /**
     * 发送im的ack消息
     */
    public static final String GOLIVE_IM_ACK_MSG_TOPIC = "golive_im_ack_msg_topic";
