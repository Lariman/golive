...
import org.golive.gift.constants.SendGiftTypeEnum;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        mqPushConsumer.setMessageListener((MessageListenerConcurrently) (msgs, context) -> {
            for (MessageExt msg : msgs) {
                ...
                AccountTradeRespDTO tradeRespDTO = goliveCurrencyAccountRpc.consumeForSendGift(tradeReqDTO);
                //如果余额扣减成功
...
//                LOGGER.info("[SendGiftConsumer] msg is {}", msg);
     ...
     * @param jsonObject
     */
    private void sendImMsgSingleton(Long userId, int bizCode, com.alibaba.fastjson.JSONObject jsonObject) {
    ...
    private void pkImMsgSend(com.alibaba.fastjson.JSONObject jsonObject, SendGiftMq sendGiftMq, Long receiverId) {
