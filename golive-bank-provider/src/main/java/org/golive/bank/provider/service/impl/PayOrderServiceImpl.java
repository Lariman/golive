...
import org.golive.bank.constants.PayProductTypeEnum;
...
public class PayOrderServiceImpl implements IPayOrderService {
    ...
    @Resource
    private IGoliveCurrencyTradeService goliveCurrencyTradeService;
    ...
    public boolean payNotify(PayOrderDTO payOrderDTO) {
        ...
        // 假设 支付成功后,要修改用户的vip经验值 -> account-provider
        // 发mq
        // 中台服务,支付的对接方
    ...
    private void payNotifyHandler(PayOrderPO payOrderPO) {
        ...
        if(payProductDTO != null && PayProductTypeEnum.GOLIVE_COIN.getCode().equals(payProductDTO.getType())){
